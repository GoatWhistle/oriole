...
from features.notifications.crud import notification_settings as notification_settings_crud
...
async def update_notification_settings(
    ...
    return await notification_settings_crud.update_settings(session, user_id, settings_update)
